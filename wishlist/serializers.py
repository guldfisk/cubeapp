...
class RequirementSerializer(serializers.Serializer):
    ...
    def update(self, instance, validated_data):
        print('requirement update', instance, validated_data)
...
def _validate_cardboard_name(cardboard_name: str) -> None:
    print('cardboard name validation', cardboard_name)
...
class CardboardWishSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'cardboard_name', 'minimum_amount', 'requirements', 'wish_id')
...
class WishSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = models.Wish
        fields = ('id', 'weight', 'cardboard_wishes', 'wish_list_id')


class WishListSerializer(serializers.ModelSerializer):
    created_date = serializers.DateTimeField(read_only = True, format = DATETIME_FORMAT)
    wishes = WishSerializer(many = True, read_only = True)


    class Meta:
        model = models.WishList
        fields = ('id', 'created_date', 'wishes')
