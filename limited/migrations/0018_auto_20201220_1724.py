...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name="match_type",
            field=utils.fields.SerializeableField(
                default=FirstToN(2), klass="mtgorp.models.tournaments.matches.MatchType"
            ),
        ...
        migrations.AddField(
            ...
            field=utils.fields.StringMapField(
                mapping=Tournament.tournaments_map, default=lambda: AllMatches, max_length=255
            ),
            preserve_default=False,
        ),
    ]
