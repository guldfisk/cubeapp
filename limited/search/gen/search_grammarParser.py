...
class search_grammarParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "<INVALID>", "<INVALID>", "<INVALID>", 
                      ...
                      "<INVALID>", "<INVALID>", "<INVALID>", "<INVALID>", 
                      "PRINTING_CODE", "NAME_CODE", "CREATOR_CODE", "WINS_CODE", 
                      "LOSSES_CODE", "DRAWS_CODE", "CUBE_CODE", "UNSIGNED_INTEGER", 
    ...
    ruleNames =  [ "start", "operation", "restriction", "value", "subset_operator", 
                   "comparison_operator" ]
    ...
    def operation(self, _p:int=0):
        ...
        try:
            ...
            if token in [search_grammarParser.T__0]:
                ...
                pass
            elif token in [search_grammarParser.PRINTING_CODE, search_grammarParser.NAME_CODE, search_grammarParser.CREATOR_CODE, search_grammarParser.WINS_CODE, search_grammarParser.LOSSES_CODE, search_grammarParser.DRAWS_CODE, search_grammarParser.CUBE_CODE, search_grammarParser.UNSIGNED_INTEGER, search_grammarParser.QUOTED_VALUE, search_grammarParser.VALUE]:
    ...
    class EqualsOperatorContext(Comparison_operatorContext):
        ...
        def __init__(self, parser, ctx:ParserRuleContext): # actually a search_grammarParser.Comparison_operatorContext
            super().__init__(parser)
            self.copyFrom(ctx)
