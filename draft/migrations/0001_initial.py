            ...
            fields=[
                ...
                (
                    ...
                    utils.fields.EnumField(
                        default=draft.models.DraftSession.DraftState["DRAFTING"], enum_type="draft.models.DraftState"
                    ),
                ),
                (
                    "limited_session",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "drafter",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="picks", to="draft.DraftSession"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "session",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="drafters", to="draft.DraftSession"
                    ),
                ),
                (
                    "user",
