    ...
    operations = [
        migrations.CreateModel(
            ...
            fields = [
                ...
                ('versioned_cube',
                 models.ForeignKey(on_delete = django.db.models.deletion.CASCADE, related_name = 'leagues', to = 'api.versionedcube')),
            ],
            options = {
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields = [
                ...
                ('updated_at', models.DateTimeField(auto_now = True)),
                ('league',
                 models.ForeignKey(on_delete = django.db.models.deletion.CASCADE, related_name = 'seasons', to = 'league.hofleague')),
                ('tournament', models.OneToOneField(on_delete = django.db.models.deletion.CASCADE, related_name = 'season',
