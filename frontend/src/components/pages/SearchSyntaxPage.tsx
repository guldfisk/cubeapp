...
const SearchSyntaxPage: React.FunctionComponent = () =>
  <div>
    ...
    <p>{'So "((cmc>2 po<=2 m>2r m<4r t;hum) || m={u/w}) f !t;soldi" is a legal query.'}</p>
    <p>Use quotes ("") to explicitly define something as a value. This is useful to search for reserved codes, such as
      "to", or for providing values with spaces.</p>
    ...
    <p>{"Example: m<{u/w}2 m>={w/u}</p"}></p>
    <p>Cards with a manacost that is an exclusive sub-set of two generic and one w/u hybrid and contains a w/u
      hybrid</p>
    <p>{"Example: m={2/r}{2/r}{2/r}"}></p>
    <p>Flame javelin.</p>
