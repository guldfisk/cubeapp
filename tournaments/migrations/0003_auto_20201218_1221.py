...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name="round",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="matches", to="tournaments.tournamentround"
            ),
        ),
        migrations.AlterField(
            model_name="tournament",
            name="state",
            field=utils.fields.EnumField(
                default=tournaments.models.Tournament.TournamentState["ONGOING"],
                enum_type="tournaments.models.TournamentState",
            ),
        ),
        migrations.AlterField(
            model_name="tournamentwinner",
